        ...
        <div class="table-responsive">
            <div class="card-body">
                ...
                <ul class="nav nav-tabs mb-3" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" data-bs-toggle="tab" href="#peribadi">Personal Info</a>
                    </li>
                    <li class="nav-item"><a class="nav-link" href="#">Maklumat Pengalaman</a></li>
                    <li class="nav-item"><a class="nav-link" href="#">Maklumat Kelayakan</a></li>
                    <li class="nav-item"><a class="nav-link" href="#">Maklumat Kelulusan Akademik</a></li>
                    <li class="nav-item"><a class="nav-link" href="#">Maklumat Pencapaian</a></li>
                    <li class="nav-item"><a class="nav-link" href="#">Maklumat Kelab</a></li>
                </ul>
                        ...
                        <div class="tab-pane fade show active" id="peribadi">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-4">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" name="jantina" type="radio" value="Perempuan"
                                            required>
